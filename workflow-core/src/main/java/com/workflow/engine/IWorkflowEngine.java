...
public interface IWorkflowEngine {
     ...
     * 获取任务对应的表单
     * 
     * <p>根据任务所在的流程定义和节点，查找绑定的表单定义。
     *
     * @param taskId 任务 ID
     * @return 表单定义（如果未绑定则返回 null）
     */
    com.workflow.form.FormDefinition getFormForTask(String taskId);

    /**
     * 提交表单数据
     * 
     * <p>验证表单数据，将字段值映射到流程变量，并完成任务。
     *
     * @param taskId   任务 ID
     * @param formData 表单数据（fieldId -> value）
     * @param userId   提交人
     * @param approved 是否批准
     * @return 表单提交结果
     */
    FormSubmitResult submitForm(String taskId, Map<String, Object> formData, String userId, boolean approved);
     ...
     * @return 附件 ID
     */
    String uploadAttachment(String taskId, String fileName, String fileType, long fileSize,
     ...
     * @return 附件列表
     */
    List<com.workflow.attachment.Attachment> getTaskAttachments(String taskId);
     ...
     * @return 文件输入流
     */
    java.io.InputStream getAttachmentContent(String attachmentId);
